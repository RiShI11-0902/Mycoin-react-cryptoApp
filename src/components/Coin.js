      ...
      <div className="div flex flex-col  md:flex-row space-y-5 items-center mt-10 w-fit p-5 mx-auto justify-around">
        <div className="md:ml-10 ml-0">
          <input
            ...
            type="text"
            placeholder="Search"
            className=" bg-white placeholder:text-slate-500 placeholder:relative placeholder:left-4 border-2 border-black lg:w-[38rem] md:w-[35rem] w-35 p-2  rounded-full -mt-16 indent-7 focus:placeholder:text-white"
          />
        </div>
